...
export function StarterUnitsSidebar({ isOpen = false, onClose, basePath = "/resources/starters/Games" }: StarterUnitsSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:static top-[72px] md:top-0 left-0 h-screen md:h-auto md:min-h-full md:self-stretch flex flex-col border-r border-cyan-200 bg-cyan-50 shadow-xl transition-all duration-300 overflow-hidden z-40 ${
          collapsed ? "w-16" : "w-72"
        } ${
      ...
      >
      {/* Header */}
      <div className="flex-shrink-0 flex items-center gap-3 px-4 py-4 border-b border-cyan-200/70 bg-cyan-50">
